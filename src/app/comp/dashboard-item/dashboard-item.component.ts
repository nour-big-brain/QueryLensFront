...
export class DashboardItemComponent implements OnInit {
  ...
  addCard(): void {
    ...
    this.dashboardService.addCardToDashboard(this.dashboard._id!, this.cardId).subscribe({
      next: (response) => {
  ...
  removeCard(cardId: string): void {
    ...
    this.dashboardService.removeCardFromDashboard(this.dashboard._id!, cardId).subscribe({
      next: (response) => {
        this.successMessage = response.message;
  ...
  shareDashboard(): void {
    ...
    this.dashboardService
      .shareDashboard(this.dashboard._id!, this.targetUserId, this.targetUsername, this.permission)
      .subscribe({
        next: (response) => {
          this.successMessage = response.message;
